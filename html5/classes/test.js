(function () {
    ...
    var canvasW = utils.getScreenSize().w;

    var canvasH = utils.getScreenSize().h;
    ...
    function init() {
        ...
        window.onresize = function () {
            canvas.width=canvasW = utils.getScreenSize().w;
            canvas.height= canvasH = utils.getScreenSize().h;
        }
        setup();
        setInterval(run, 30);
    }
